...
//DEBUGS FOR ACCIDENTAL CLICKING OF DECIMAL POINT
    if (Calculator.Wait_Second_Operand === true) return;
    if (!Calculator.Display_Value.includes(dot)) {

//IF DISPLAY_VALUE DOESNT HAVE A DECIMAL POINT, WE WANT TO ADD A DECIMAL POINT.
...
keys.addEventListener('click', (event) => {
    ...
    //if what was clicked was not a button, exit the function
    ...
    //ENSURE ac CLEARS ALL INPUTS FROM CALCULATOR SCREEN
